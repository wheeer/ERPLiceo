...
def calcular_remuneraciones(request):
    ...
    try:
        ...
        for empleado in empleados:
            ...
            salud_porcentaje = config.get("salud_porcentaje", 0.07)
            ...
            for hora_extra in horas_extra_empleado:
                ...
                total_horas_extra += round(horas * valor_hora * recargo)

            total_imponible = sueldo_base + gratificacion + total_horas_extra
            porcentaje_afp = porcentajes_afp.get(afp_nombre, 0.1145)
            afp = round(total_imponible * porcentaje_afp)
            salud = round(total_imponible * salud_porcentaje)
